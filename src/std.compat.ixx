...
export {
    ...
    template<int = 0>
    _Check_return_ _CRT_INSECURE_DEPRECATE(ctime_s) inline char * __CRTDECL ctime(
        _In_ const time_t *const _Time) noexcept
    /* strengthened */ {
    ...
    template<int = 0>
    _Check_return_ _CRT_INSECURE_DEPRECATE(gmtime_s) inline tm * __CRTDECL gmtime(
        _In_ const time_t *const _Time) noexcept
    /* strengthened */ {
